    ...
    <section class="section dashboard">
      <div class="row">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-1" id="humidity-data">
                  <h6 id="slave1-humidity">Slave 2 : 75%</h6>
                </div>
              </div>
            </div>
        ...
        <div class="col-xxl-3 col-md-6">
          <div class="card info-card sales-card">
            <div class="card-body">
              <h5 class="card-title">Paket Data <span id="data-title">| Slave 2</span></h5>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-1" id="humidity-data">
                  ...
                  <h6 id="slave1-humidity">Slave 2 : 1000 B</h6>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3" id="revenue-data">
                  <h6 id="slave1-revenue">Slave 2 : 1220</h6>
                </div>
              </div>
            </div>
             ...
             <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3" id="packetloss-data">
                  <h6 id="slave1-packetloss">Slave 2 : 0,25% (52)</h6>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data Slave 2</h5>
              <!-- Line Chart -->
          ...
          <div class="card" >
            <div class="card-body">
              <h5 class="card-title">Data sensor Slave 2</h5>
              <!-- Default Table -->
